...
(function(){$('button[data-src]').on('click',function(e){e.preventDefault();var src=$(this).data('src');$.ajax({url:src,type:'GET',dataType:'text'}).done(function(data){eval(data);}).fail(function(e){console.log(e);console.log('hubo un error al cargar el código de ejemplo');});});$('h2').on('click',function(e){e.preventDefault();location.hash=$(this).attr('id');markActive();});var ribbon=document.querySelector('#gh-fork-ribbon').import.querySelector('.github-fork-ribbon-wrapper');$(ribbon).appendTo('body');(function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){(i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)})(window,document,'script','//www.google-analytics.com/analytics.js','ga');ga('create','UA-48432002-3','auto');ga('send','pageview');function markActive(){var hash=location.hash;if(hash){$('h2').removeClass('active');$(hash).addClass('active');}}
markActive();})();if(!Object.assign){Object.defineProperty(Object,'assign',{enumerable:false,configurable:true,writable:true,value:function(target,firstSource){'use strict';if(target===undefined||target===null){throw new TypeError('Cannot convert first argument to object');}
var to=Object(target);for(var i=1;i<arguments.length;i++){var nextSource=arguments[i];if(nextSource===undefined||nextSource===null){continue;}
nextSource=Object(nextSource);var keysArray=Object.keys(Object(nextSource));for(var nextIndex=0,len=keysArray.length;nextIndex<len;nextIndex++){var nextKey=keysArray[nextIndex];var desc=Object.getOwnPropertyDescriptor(nextSource,nextKey);if(desc!==undefined&&desc.enumerable){to[nextKey]=nextSource[nextKey];}}}
return to;}});}
if(!Object.is){Object.is=function(v1,v2){if(v1===0&&v2===0){return 1/v1===1/v2;}
